      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 rounded-lg border text-gray-700 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all"
          />
        </div>
